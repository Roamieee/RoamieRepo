...
class _TranslationToolState extends State<TranslationTool> {
 ...
 Future<void> _handleOcr(ImageSource source) async {
   setState(() {
    _translatedText = "Accessing ${source == ImageSource.camera ? 'Camera' : 'Gallery'}...";
   });
   ...
   try {
    ...
    if (image == null) {
     setState(() {
      _translatedText = "${source == ImageSource.camera ? 'Capture' : 'Selection'} cancelled.";
     });
     return;
    }
    ...
    setState(() {
     _translatedText = "Error during image processing. Check permissions and native setup: $e";
    });
   }
  }
          ...
          Row(
           ...
           children: [
            ...
            IconButton(
             ...
             onPressed: _showImageSourcePicker, // Calls the picker sheet
            ),
           ],
          ),
          Padding(
